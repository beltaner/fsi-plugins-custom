# Task 3 — Valuation & Quality Scoring

## Goal

Convert the research (Task 1) and the financial model (Task 2) into a complete
...
- Task 2 complete: `{TICKER}_model.xlsx` read (forecast assumptions, FCF
...
1. **Read all prerequisites.** Open Task 1 markdown + Task 2 Excel. Cache the
...
- Supporting metrics (e.g., 10-year average ROIC from Task 2 model)
- Direction (improving / stable / weakening)
Aggregate: /30 with bands per framework (24-30 exceptional, 18-23 solid, etc.)

### Sheet 3: DCF
- 10-year explicit FCF forecast (linked from Task 2 model)
- WACC build:
...
### Sheet 4: Multiples
Table:
- Current P/E, EV/EBIT, EV/EBITDA, P/FCF (all using NTM estimates from Task 2)
