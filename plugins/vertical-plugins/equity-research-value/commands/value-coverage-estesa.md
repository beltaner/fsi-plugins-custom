...
description: "Produce a value-investing initiating coverage report in Italian with the standardized house visual identity (ICE golden-reference layout, navy/teal/amber charts, Italian section titles). A 6-task workflow (research, transcript evolution, modeling, valuation, charts, assembly). This is the preferred edition for finished reports."
